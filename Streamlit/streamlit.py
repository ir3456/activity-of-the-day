...
REQUESTS_URL = "http://localhost:8502/"
...
if st.button('Check weather'):
    st.write(f"Based on today's weather forecast, it is a perfect day for {st.session_name.activity_name} at the following times: ")
